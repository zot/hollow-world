...
- **CRC Cards**: `specs-crc/crc-ViewManager.md`, `specs-crc/crc-IView.md`
- **Sequences**: View transition flows in `specs-crc/seq-*.md`
- **UI Specs**: View-specific implementations in `specs-ui/*.md`
